  ...
  <style>
    * { box-sizing: border-box; }
    body, html {
      ...
      background: linear-gradient(135deg, #007BFF, #0056b3); /* Warna biru khas admin */
      display: flex;
    ...
    ul.colorlib-bubbles li:nth-child(1) { left: 10%; }
    ...
    ul.colorlib-bubbles li:nth-child(5) { left: 70%; }
...
<div class="footer-text">
  <p>© 2020 M Syifaul Anam All rights reserved | Design by <a href="https://colorlib.com/" target="_blank">Colorlib</a></p>
</div>
